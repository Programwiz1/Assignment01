 ...
 * Assignment and Exercise Number: Lab01 Exercise E
 * Names: Monil Patel
            ...
            if (!operation.equalsIgnoreCase("sqrt") && !operation.equalsIgnoreCase("log") && !operation.equalsIgnoreCase("log10") && !operation.equalsIgnoreCase("sin") && !operation.equalsIgnoreCase("cos") && !operation.equalsIgnoreCase("tan") && !operation.equalsIgnoreCase("factorial")) {
                ...
                switch (operation.toLowerCase()) {
                    ...
                    case "pow":
                        ...
                        break;
                    case "permutation":
                    	if (num2>100 || num1<=0 || num2<0 || num1<num2) {
...
//permutations
public static double permutations(int a, int b) {

	return (factorial((double)a))/(factorial((double)(a-b)));
